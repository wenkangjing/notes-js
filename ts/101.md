...
- what’s the shape of `moduleA`? --> `.ts/.tsx` files, or in a `.d.ts`
...
> **DON"T** `import/require` Use ES module syntax instead. `import/require` for importing type only
...
`lib.d.ts` `global.d.ts`

[] https://basarat.gitbooks.io/typescript/docs/types/freshness.html
